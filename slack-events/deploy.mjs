...
const config = {
  ...
  servicesLegacyControlBasicPassword: required("ALDER_SERVICES_LEGACY_CONTROL_BASIC_AUTH_PASSWORD"),
  servicesLegacyControlBasicUsername: required("ALDER_SERVICES_LEGACY_CONTROL_BASIC_AUTH_USERNAME"),
